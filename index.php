...
<body>
    ...
    <section class="intro" id="intro">
      <div class="Intro">
        <div class="gridintro">
          ...
          <div class="mypic">
            <img src="assets/images/me.jpg" alt="kevpic" />
          </div>

          <p class="quick">
            I build and fix computers, build website sites, take really nice pictures, I taught english a
            bit. I love to swim, rollerskate, skate, cycling, running. I'm also crazy for a good movie and tv show
            night.
          </p>
          <div class="attachements">
            <div class="dl_div">
              <label for="dl_btn" id="dl_label" class="dl_label">Download a PDF version</label>
              <a href="assets/attachements/2023 CV2.pdf" target="_blank" name="dl_btn" class="dl_btn">Download</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="timelinecontainer">
        <div class="timelineblockcontainer">
          <div class="timelineblock">
            ...
            Réseaux locaux, Architecture réseau, Adressage IPV4 et IPV6,
            HTML, CSS, JavaScript, Anglais, Algorithme
          </div>
          <div class="timelineblock">
          ...
          <div class="timelineblock">
            ...
            pécialisation web et validation de mon précédant BTS IRIS en 2014
          ...
          <div class="timelineblock">
            ...
            <h3>Technicien de maintenance</h3> <br>
          ...
          <div class="timelineblock">
            ...
            <h3>Stagiaire Technicien Maintenance</h3> <br>
          ...
          <div class="timelineblock">
            <div class="date">2012</div>
            <h3>GIE Convergence </h3>
            <span>Lycée Pierre Méchain, 02000 Laon</span>
  ...
  <footer>
    <div class="socials">
      ...
      <a href="#" class="infoicon fa fa-car"></a>
      <a href="#" class="infoicon fa fa-home"></a>
    </div>
